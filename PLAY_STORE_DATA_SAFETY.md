...
### 2. Data Types
Kunjika technically "handles" the following data locally, but **none** is collected or shared:
...
You should host the `PRIVACY_POLICY.html` content on a public URL (e.g., GitHub Pages or a simple Gist) to provide the link to Google.
